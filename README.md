...
| `plan_selfcheck_sample_collection.py` | Preflights aligned selfcheck samples before direct signal fusion, reporting which records lack enough samples, total sample deficit, sample-quality gate projection, and rerun commands for INSIDE cache export or fusion replay. |
