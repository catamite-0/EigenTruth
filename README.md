...
| `run_source_family_structured_qa_lane_batch_workflow.py` | Materializes selected lane execution batches as compatible fact-collection corpora, reuses the local source-family workflow, and records batch provenance before any downstream route/mapping gate. |
...
| `run_source_family_structured_qa_lane_batch_workflow.py` | Replays selected lane execution batches through the local source-family fact-collection workflow and writes batch-scoped provenance. |
...
| `run_source_family_structured_qa_lane_batch_workflow.py` | 将选定 lane execution batch 物化成兼容的 fact-collection corpus，复用本地 source-family workflow，并在进入 route/mapping gate 前记录 batch provenance。 |
...
| `run_source_family_structured_qa_lane_batch_workflow.py` | 将选定 lane execution batches 接到本地 source-family fact-collection workflow，并写出 batch-scoped provenance。 |
