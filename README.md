...
| `run_retrieval_semantic_gap_review_workflow.py` | Chains retrieval semantic-gap handoff, alignment fact-review corpus building, deterministic rule review, and reviewed-source promotion gating into one scoped covered-fact preparation workflow. |
...
| `run_retrieval_semantic_gap_review_workflow.py` | 将 retrieval semantic-gap handoff、alignment fact-review corpus、确定性 rule review 和 reviewed-source promotion gate 串成一个 scoped covered-fact 准备闭环。 |
