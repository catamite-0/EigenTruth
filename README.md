...
| `run_source_family_structured_qa_fact_collection_workflow.py` | 用本地 source-family catalog 执行这些 fact-collection 请求桶，产出候选 adapter matches，重建 structured QA candidate corpus，并把 world-model/calculator rule stub 保持为非证据输入。 |
