...
| `run_adapter_readiness_workflow.py` | Combines adapter-family quality gates and cache-profile performance gates into one final adapter readiness decision. |
...
| `run_adapter_readiness_workflow.py` | 将 adapter-family 质量门槛和 cache-profile 性能门槛合并为一个最终 adapter readiness decision。 |
