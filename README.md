...
| `rollup_citation_search_batch_evidence.py` | 将 citation/source-family 子 workflow 汇总为 release-auditable batch report，保留 expected/observed batch coverage、child manifest 校验、adapter-gate coverage/status、provenance/query-sweep/comparison 聚合指标和 fail-closed blocker reason。 |
