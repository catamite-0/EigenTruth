...
| `compare_external_evidence_baselines.py` | Combines route-baseline promotion, answer-echo stress-control evidence, and text/length redline score-ensemble reports into one fail-closed external-evidence comparison artifact. |
...
| `compare_external_evidence_baselines.py` | 将 route-baseline promotion、answer-echo stress-control 证据和 text/length redline score-ensemble report 合并成一个 fail-closed 外部证据比较 artifact。 |
