...
- **Cost:** low-medium. **Status:** spectrum diagnostics foundation implemented
  ...
  `eval_truthfulqa.py --include-layer-spectra`; shrinkage and real AUROC
...
| E2 | 2026-06-25 | partial: spectrum diagnostics landed and can be emitted by TruthfulQA reports; shrinkage/AUROC gate pending | `TruthManifold.spectrum()` / `covariance_spectrum()` unit tests; `eval_truthfulqa.py --include-layer-spectra` tests |
| E3 | | pending | |
| E4 | | pending | |
| E5 | | pending | |
| E6 | | pending | |
