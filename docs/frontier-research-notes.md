...
2. Execute the registered unresolved citation/search and world-model queue through external source adapters, then ingest and provenance-audit the returned documents before route promotion.
