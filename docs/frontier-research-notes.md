...
2. Add a promotion gate for the correction-filled rule candidate, then expand
   ...
   deterministic calculator/entity-role/world-model results that pass that
   gate should enter correction handoff. The complete source-backed replay now
   proves local-catalog coverage is not enough (`0/88` mapped).
