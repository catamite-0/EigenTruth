...
def build_frontier_queue_execution_smoke(
    ...
    *,
    ...
    review gate, and finally dry-runs the approved execution plan. It never
    runs child frontier commands or treats any fixture artifact as verifier
    evidence.
    """
    ...
    *,
    ...
    return {
        ...
        "scope": (
            ...
            "It validates command-plan staging, review gating, and dry-run execution "
            "without executing child frontier workflows or creating verifier evidence."
        ),
        "paths": {
