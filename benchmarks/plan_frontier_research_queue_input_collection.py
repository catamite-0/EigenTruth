...
ARTIFACT_INPUT_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "frontier_bound_command_plan": {
        ...
        "artifact_family": "frontier_bound_command_plan",
        "target_flag": "--bound-command-plan",
        "recommended_next_tools": (
        ...
        "review_skeleton": {
            "artifact_path": "",
            "source_workflow": "frontier_research_queue_bound_command_plan",
            "artifact_manifest": "",
    ...
    "frontier_command_bindings": {
        "lane": "frontier_queue_execution",
        "artifact_family": "frontier_command_bindings",
        "target_flag": "--base-bindings",
        "recommended_next_tools": (
            "benchmarks/review_frontier_research_queue_command_bindings.py",
        ),
        "required_review_fields": (
        ...
        "review_skeleton": {
            "artifact_path": "",
            "source_workflow": "frontier_research_queue_command_bindings",
            "artifact_manifest": "",
            "allowed_label_use": "not_allowed",
            "review_status": "approved",
            "not_verifier_evidence": True,
    ...
    "frontier_command_review_decisions": {
        "lane": "frontier_queue_execution",
        "artifact_family": "frontier_command_review_decisions",
        "target_flag": "--review-decisions",
        "recommended_next_tools": (
            "benchmarks/review_frontier_research_queue_command_bindings.py",
        ),
        "required_review_fields": (
        ...
        "review_skeleton": {
            "artifact_path": "",
            "source_workflow": "frontier_research_queue_command_binding_review_decisions",
            "artifact_manifest": "",
            "allowed_label_use": "not_allowed",
            "review_status": "approved",
            "not_verifier_evidence": True,
    ...
    "frontier_command_plan": {
        "lane": "frontier_queue_execution",
        "artifact_family": "frontier_command_plan",
        "target_flag": "--command-plan",
        "recommended_next_tools": (
        ...
        "review_skeleton": {
            "artifact_path": "",
            "source_workflow": "frontier_research_queue_command_plan",
            "artifact_manifest": "",
            "allowed_label_use": "not_allowed",
            "review_status": "approved",
            "not_verifier_evidence": True,
    ...
    "approved_frontier_command_bindings": {
        "lane": "frontier_queue_execution",
        "artifact_family": "approved_frontier_command_bindings",
        "target_flag": "--bindings",
        "recommended_next_tools": (
            "benchmarks/bind_frontier_research_queue_command_plan.py",
        ),
        "required_review_fields": (
    ...
    "reviewed_frontier_bound_command_plan": {
        "lane": "frontier_queue_execution",
        "artifact_family": "reviewed_frontier_bound_command_plan",
        "target_flag": "--bound-command-plan",
        "recommended_next_tools": (
